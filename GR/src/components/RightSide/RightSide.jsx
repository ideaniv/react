  ...
  return (
    <nav className="flex flex-col text-[1.3rem] text-white py-[140px] pl-[46px] pr-[29.72px]">
      <div className="flex cursor-pointer">
        <img className="size-[1.3rem] mr-[4px]" src={home} alt="Home" />
        <a className="mb-[90px]">Your profile</a>
      </div>
      <div className="flex cursor-pointer">
        <img className="size-[1.3rem] mr-[4px]" src={book} alt="Book" />
        <a className="mb-[90px]">Your Repositories</a>
      </div>
      <div className="flex cursor-pointer">
        <img className="size-[1.3rem] mr-[4px]" src={globe} alt="Home" />
        <a className="mb-[90px]">Your Links</a>
      </div>
      <div className="flex cursor-pointer">
        <img className="size-[1.3rem] mr-[4px]" src={pack} alt="Home" />
        <a className="mb-[90px]">Your Points</a>
      </div>
      <div className="flex cursor-pointer">
        <img className="size-[1.3rem] mr-[4px]" src={star} alt="Home" />
